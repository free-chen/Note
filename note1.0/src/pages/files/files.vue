<template>
  <el-container style="margin-left: -20px;margin-top: -20px;height: 900px;">
    <el-aside style="border-right: solid 1px #e6e6e6;">
      <sidebar @send="send"></sidebar>
    </el-aside>
    <el-main>
      <noteview :sends="sends"></noteview>
    </el-main>
  </el-container>
</template>
...
export default {
  ...
  methods: {
    WebsocketConnect() {
      var socket = new SockJS("http://139.108.195.47:8001/endpoint-websocket");
      // var socket = new SockJS("http://39.108.195.47:8001/endpoint-websocket");
